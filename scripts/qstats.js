$(document).ready(function(){
    var questionTable = $('#questions_table2');
    var numOfRows = 0;
    ...
    var qId = document.getElementById('valamid');
    ...
    var loadData = function(obj) {
        $.ajax({
            url: 'ReadAnswerList.php?bottom=' + limit.bottom + '&number=' + limit.number + "&qid=" + qId.innerHTML,
            type: "GET",
            cache: false,
