(function () {
    ...
    function va(a, b, c) {
        if (a && b && c) {
            ...
            f.target = "_blank";
            if (new Blob) {
                for (var g = a.replace(/^data:[a-z/]*;base64,/, ""), g = atob(g), l = new ArrayBuffer(g.length), q = new Uint8Array(l), h = 0; h < g.length; h++)q[h] = g.charCodeAt(h);
                b = new Blob([l], {type: "image/" + b});
                try {
    ...
    function w(a, b, c) {
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) :
            ...
            axisY2: {internalMinimum: null, internalMaximum: null}
    ...
    function z(a, b, c, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++)this.stripLines.push(new ma(this.chart, this._options.stripLines[b], a.theme,
    ...
    var u = !!document.createElement("canvas").getContext, ha = {
            ...
            colorSet1: "#286C2B #444444 #7F6084 #86B402 #A2D1CF #C8B631 #6DBCEB #52514E #4F81BC #A064A1 #F79647".split(" "),
        ...
        U = {
            theme1: {
                ...
                Title: {
                    fontFamily: u ? "Verdana, Calibri, Optima, Candara, Geneva, sans-serif" : "calibri",
                    fontSize: 24,
                    fontColor: "#666",
                    fontWeight: "bold",
                    verticalAlign: "top",
            ...
            b = null;
            for (var v = 0; l && v < l.length; v++)if (b = l[v], "." === b && 0 > q)q = v; else {
                if ("%" === b)g *= 100; else if ("\u2030" === b) {
                    ...
                    q = v + b.length - 1;
                    continue
                } else"E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || (p = !0);
            ...
            a = (b[1] + "").split("");
            g && "0" === g[0] && g.shift();
            for (v = p = l = m = q = 0; 0 < h.length;)if (b = h.pop(), "#" === b || "0" === b)if (q++, q === n) {
                var t = g, g = [];
                if ("0" === b)for (b = n - m - (t ? t.length : 0); 0 < b;)t.unshift("0"), b--;
                for (; 0 < t.length;)c = t.pop() + c, v++, 0 === v % p && (l === r && 0 < t.length) && (c = f + c);
                d && (c = "-" + c)
            } else 0 < g.length ? (c = g.pop() + c, m++, v++) : "0" === b && (c = "0" + c, m++, v++), 0 === v % p && (l ===
            r && 0 < g.length) && (c = f + c); else"E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? "," === b ? (l++, p = v, v = 0, 0 < g.length && (c = f + c)) : c = 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? b.slice(1, b.length - 1) + c : b + c : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), c += b.replace(/[0]+/, function (a) {
                return J(s, a.length)
            }));
            d = "";
            for (f = !1; 0 < k.length;)b = k.shift(), "#" === b || "0" === b ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), f = !0) : "0" === b && (d += "0", f = !0) : 1 < b.length &&
            ...
            return {x: b, y: c}
        }, ua = !0, ja = window.devicePixelRatio || 1, da = 1, Q = ua ? ja / da : 1, Ca = {
    ...
    w.prototype._updateOptions = function () {
        ...
        this._options.zoomEnabled ? (this._zoomButton || (R(this._zoomButton = document.createElement("button")), L(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), F(this._zoomButton, "click", function () {
            a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, L(a, a._zoomButton,
                "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, L(a, a._zoomButton, "pan"));
            a.render()
        })), this._resetButton || (R(this._resetButton = document.createElement("button")), L(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), F(this._resetButton, "click", function () {
            a._toolTip.hide();
        ...
        this._menuButton ? this.exportEnabled ? ka(this._menuButton) : R(this._menuButton) : this.exportEnabled && u && (this._menuButton = document.createElement("button"), L(this, this._menuButton, "menu"),
            this._toolBar.appendChild(this._menuButton), F(this._menuButton, "click", function () {
        ...
        if (!this._dropdownMenu && this.exportEnabled && u) {
            ...
            F(b, "click", function () {
                va(a.canvas, "png", a.exportFileName);
                R(a._dropdownMenu)
            }, !0)
        }
        ...
        if ("undefined" === typeof ha.Chart.creditHref)this.creditHref = "", this.creditText = ""; else var c = this.updateOption("creditText"), d = this.updateOption("creditHref");
    ...
    w.prototype._initialize = function () {
        ...
        this.data = [];
        for (var a = 0, b = 0; b < this._options.data.length; b++)if (a++, !this._options.data[b].type || 0 <= w._supportedChartTypes.indexOf(this._options.data[b].type)) {
            var c =
    ...
    w.prototype.render = function (a) {
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)for (var b = this.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++) {
            var d = b.plotUnits[c];
            ...
            for (var e =
                0; e < d.dataSeriesIndexes.length; e++)this._dataInRenderedOrder.push(this.data[d.dataSeriesIndexes[e]])
        }
    ...
    w.prototype.categoriseDataSeries = function () {
        for (var a = "", b = 0; b < this.data.length; b++)if (a = this.data[b], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= w._supportedChartTypes.indexOf(a.type)) {
    ...
    w.prototype._processData = function () {
        ...
        for (var a =
            0; a < this.plotInfo.plotTypes.length; a++)for (var b = this.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++) {
            var d = b.plotUnits[c];
    ...
    w.prototype._processMultiseriesPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
            ...
            if (l.dataPoints[q].x && l.dataPoints[q].x.getTime || "dateTime" === l.xValueType)f = !0;
            for (q = 0; q < l.dataPoints.length; q++) {
                "undefined" === typeof l.dataPoints[q].x && (l.dataPoints[q].x = q);
                ...
                if (!(d < n) || h) {
                    ...
                    if (d > m && !k)k = !0; else if (d > m && k)continue;
    ...
    w.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], l = [], q = 0; q < a.dataSeriesIndexes.length; q++) {
                ...
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)var r = this.sessionVariables.axisX.internalMinimum ?
                    this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity, p = this.sessionVariables.axisX.internalMaximum ? this.sessionVariables.axisX.internalMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
                if (h.dataPoints[k].x && h.dataPoints[k].x.getTime || "dateTime" === h.xValueType)f = !0;
                for (k = 0; k < h.dataPoints.length; k++) {
                    ...
                    if (!(d < r) || n) {
                        ...
                        if (d > p && !m)m = !0; else if (d > p && m)continue;
            ...
            for (k in g)isNaN(k) || (a = g[k], a < b.min && (b.min = a), a > b.max && (b.max = a), k < c.viewPortMin || k > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)));
            for (k in l)isNaN(k) || (a = l[k], a < b.min && (b.min = a), a > b.max && (b.max = a), k < c.viewPortMin || k > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)))
        }
    };
    w.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, l = !1, q = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)var p = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity, s = this.sessionVariables.axisX.internalMaximum ? this.sessionVariables.axisX.internalMaximum :
                    this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
                if (k.dataPoints[n].x && k.dataPoints[n].x.getTime || "dateTime" === k.xValueType)f = !0;
                for (n = 0; n < k.dataPoints.length; n++) {
                    ...
                    if (!(d < p) || m) {
                        ...
                        if (d > s && !r)r = !0; else if (d > s && r)continue;
    ...
    w.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, l = !1, q = 0; q < a.dataSeriesIndexes.length; q++) {
            var h = this.data[a.dataSeriesIndexes[q]], k = 0, n = !1, m = !1;
            if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)var r = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum :
            ...
            if (h.dataPoints[k].x && h.dataPoints[k].x.getTime || "dateTime" === h.xValueType)l = !0;
            for (k = 0; k < h.dataPoints.length; k++) {
                "undefined" === typeof h.dataPoints[k].x && (h.dataPoints[k].x = k);
    ...
    w.prototype.getDataPointAtXY = function (a, b, c) {
        ...
        a = null;
        b = !1;
        for (c = 0; c < d.length; c++)if ("line" === d[c].dataSeries.type || "stepLine" === d[c].dataSeries.type || "area" === d[c].dataSeries.type || "stepArea" === d[c].dataSeries.type)if (e = S("markerSize", d[c].dataPoint, d[c].dataSeries) || 8, d[c].distance <= e / 2) {
            b = !0;
            break
        }
    ...
    w.prototype.getObjectAtXY = function (a, b, c) {
        var d = null;
        if (c = this.getDataPointAtXY(a, b, c || !1))d = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (u)d = sa(a, b, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
    ...
    w.prototype._touchEventHandler = function (a) {
        if (a.changedTouches &&
            ...
            if (!(c && 1 < c.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled)this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (c = 0; c < b.length; c++)e = b[c], f = document.createEvent("MouseEvent"), f.initMouseEvent(e, !0, !0, window, 1, d.screenX, d.screenY, d.clientX, d.clientY, !1,
    ...
    w.prototype._mouseEventHandler = function (a) {
        if (this.interactivityEnabled)if (this._ignoreNextEvent)this._ignoreNextEvent = !1; else {
            ...
            if (!e) {
                if (w.capturedEventParam)d =
                    w.capturedEventParam, "mouseup" === c && (w.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", d.chart._mouseEventHandler, !1)), d.hasOwnProperty(c) && d[c].call(d.context, b.x, b.y); else if (this._events) {
    ...
    w.prototype._plotAreaMouseUp = function (a, b) {
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            var e = 0, e = this.axisX.lineCoordinates, e =
                "xySwapped" === this.plotInfo.axisPlacement ? b - this.dragStartPoint.y : this.dragStartPoint.x - a;
            ...
            if (2 < Math.abs(e)) {
                ...
                (d = this.axisX.sessionVariables.internalMaximum - this.axisX._absoluteMaximum, this.axisX.sessionVariables.internalMaximum -= d, this.axisX.sessionVariables.internalMinimum -= d, e = !0), e && this.render(); else if (this.zoomEnabled) {
                    this.resetOverlayedCanvas();
                    if (!this.dragStartPoint)return;
                    "xySwapped" === this.plotInfo.axisPlacement ? (c = Math.min(this.dragStartPoint.y, b), d = Math.max(this.dragStartPoint.y, b), 1 < Math.abs(c - d) && (e = this.axisX.lineCoordinates, d = this.axisX.maximum - (this.axisX.maximum - this.axisX.minimum) / e.height *
                ...
                this.zoomEnabled && "none" === this._zoomButton.style.display && (ka(this._zoomButton, this._resetButton), L(this,
                    this._zoomButton, "pan"), L(this, this._resetButton, "reset"))
            }
        }
        this.isDrag = !1
    };
    w.prototype._plotAreaMouseMove = function (a, b) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled) ?
                this._toolTip.hide() : !this._toolTip.enabled || (this.panEnabled || this.zoomEnabled) || this._toolTip.mouseMoveHandler(a, b);
            if (2 < Math.abs(c) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled) {
                ...
                c = 0;
                this.axisX.sessionVariables.internalMinimum < this.axisX._absoluteMinimum - X(this.axisX.interval, this.axisX.intervalType) ? (c = this.axisX._absoluteMinimum - X(this.axisX.interval,
                ...
                c.y1, a - this.dragStartPoint.x, c.y2 - c.y1), this.overlaidCanvasCtx.globalAlpha = d)
    ...
    w.prototype.preparePlotArea = function () {
        ...
        this.axisX && b ? (a.x1 = this.axisX.lineCoordinates.x1 < this.axisX.lineCoordinates.x2 ? this.axisX.lineCoordinates.x1 : b.lineCoordinates.x1, a.y1 = this.axisX.lineCoordinates.y1 < b.lineCoordinates.y1 ? this.axisX.lineCoordinates.y1 :
        ...
        u || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px",
    ...
    w.prototype.renderIndexLabels = function () {
        var a = this.plotArea.ctx;
        a.textBaseline = "middle";
        for (var b = this.plotArea, c = 0; c < this._indexLabels.length; c++) {
            var d = this._indexLabels[c], e, f, g;
            a.fillStyle = S("indexLabelFontColor", d.dataPoint, d.dataSeries);
            a.font = ta("indexLabel", d.dataPoint, d.dataSeries);
            var l =
                this.replaceKeywordsWithValue(S("indexLabel", d.dataPoint, d.dataSeries), d.dataPoint, d.dataSeries, null, d.indexKeyword), q = a.measureText(l).width, h = S("indexLabelFontSize", d.dataPoint, d.dataSeries), k = S("indexLabelPlacement", d.dataPoint, d.dataSeries), n = S("indexLabelOrientation", d.dataPoint, d.dataSeries), m = g = 0, r = 0, p = 0, p = m = r = 0, s = d.direction;
            d.point.x < b.x1 || (d.point.x > b.x2 || d.point.y < b.y1 || d.point.y > b.y2) || ("column" === d.chartType || "stackedColumn" === d.chartType || "stackedColumn100" === d.chartType || "bar" === d.chartType ||
            ...
            "bubble" === d.chartType && (p = -h / 2), f = 0 < s ? Math.max(d.point.y - h / 2 - p, b.y1 + h / 2) : Math.min(d.point.y + h / 2 + p, b.y2 - h / 2)) : "vertical" === n && (e = d.point.x, "bubble" === d.chartType && (p = -q / 2), f = 0 < s ? Math.max(d.point.y - p, b.y1 + q) : Math.min(d.point.y + q + p, b.y2), g = -90)), a.save(), a.translate(e, f), a.rotate(Math.PI / 180 * g), a.fillText(l, 0, 0), a.restore())
        }
    };
    w.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                this._eventManager.objectMap[q] = {objectType: "dataSeries", dataSeriesIndex: f};
                q = A(q);
                c.strokeStyle = q;
                ...
                b.beginPath();
                if (0 < l.length) {
                    for (var r = !1, k = 0; k < l.length; k++)if (n = l[k].x.getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin ||
                        n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof l[k].y)0 < k && (b.stroke(), u && c.stroke()), r = !0; else {
                        ...
                        h ||
                        r ? (b.beginPath(), b.moveTo(n, m), u && (c.beginPath(), c.moveTo(n, m)), r = h = !1) : (b.lineTo(n, m), u && c.lineTo(n, m), 0 == k % 500 && (b.stroke(), b.beginPath(), b.moveTo(n, m), u && (c.stroke(), c.beginPath(), c.moveTo(n, m))));
                        ...
                        (l[k].indexLabel || g.indexLabel) && this._indexLabels.push({
                            chartType: "line", dataPoint: l[k], dataSeries: g,
                            point: {x: n, y: m}, color: q
                        })
                    }
                    b.stroke();
                    u && c.stroke()
    ...
    w.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                {objectType: "dataSeries", dataSeriesIndex: f};
                q = A(q);
                c.strokeStyle = q;
                c.lineWidth = 0 < g.lineThickness ? Math.max(g.lineThickness, 4) : 0;
                q = g._colorSet[0];
                ...
                b.beginPath();
                if (0 < l.length) {
                    for (var r = !1, k = 0; k < l.length; k++)if (n = l[k].getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof l[k].y)0 < k && (b.stroke(), u && c.stroke()), r = !0; else {
                        var p = m;
                        ...
                        h || r ? (b.beginPath(), b.moveTo(n, m), u && (c.beginPath(), c.moveTo(n, m)), r = h = !1) : (b.lineTo(n, p), u && c.lineTo(n, p), b.lineTo(n, m), u && c.lineTo(n, m), 0 == k % 500 && (b.stroke(), b.beginPath(), b.moveTo(n, m),
                        u && (c.stroke(), c.beginPath(), c.moveTo(n, m))));
                        if (0 < l[k].markerSize || 0 < g.markerSize)p = g.getMarkerProperties(k, n, m, b), d.push(p), s = A(s), u && d.push({
                            x: n,
                            y: m,
                            ctx: c,
                            type: p.type,
    ...
    w.prototype.renderSpline = function (a) {
        function b(a) {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3)c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), u && d.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), 0 < b && 0 === b % 3E3 && (c.stroke(), c.beginPath(), c.moveTo(a[b + 3].x, a[b + 3].y), u && (d.stroke(), d.beginPath(), d.moveTo(a[b + 3].x, a[b + 3].y)));
                c.stroke();
                u && d.stroke()
            }
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                c.beginPath();
                if (0 < q.length)for (k =
                                          0; k < q.length; k++)if (n = q[k].getTime ? q[k].x.getTime() : q[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof q[k].y)0 < k && (b(r), r = []); else {
                    n = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                    ...
                    this._eventManager.objectMap[p] = {
                        id: p,
                        objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: n, y1: m
                    };
                    r[r.length] = {x: n, y: m};
                    ...
                    (q[k].indexLabel || l.indexLabel) && this._indexLabels.push({
                        chartType: "spline",
                        dataPoint: q[k],
                        dataSeries: l,
                        point: {x: n, y: m},
    ...
    var D = function (a,
        ...
        a.globalAlpha = 1;
        0 < g && (m = 0 === g % 2 ? 0 : 0.5, a.beginPath(), a.lineWidth = g, a.strokeStyle = l, a.moveTo(b, c), a.rect(b - m, c - m, d - b + 2 * m, e - c + 2 * m), a.stroke());
        a.restore();
        !0 === q && (a.save(), a.beginPath(), a.moveTo(b, c), a.lineTo(b + r, c + r), a.lineTo(d - r, c + r), a.lineTo(d, c), a.closePath(), g = a.createLinearGradient((d +
        b) / 2, c + r, (d + b) / 2, c), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === h && (a.save(), a.beginPath(), a.moveTo(b, e), a.lineTo(b + r, e - r), a.lineTo(d - r, e - r), a.lineTo(d, e), a.closePath(), g = a.createLinearGradient((d + b) / 2, e - r, (d + b) / 2, e), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === k && (a.save(), a.beginPath(), a.moveTo(b, c), a.lineTo(b + r, c + r), a.lineTo(b + r, e - r), a.lineTo(b, e), a.closePath(), g = a.createLinearGradient(b +
        r, (e + c) / 2, b, (e + c) / 2), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === n && (a.save(), a.beginPath(), a.moveTo(d, c), a.lineTo(d - r, c + r), a.lineTo(d - r, e - r), a.lineTo(d, e), g = a.createLinearGradient(d - r, (e + c) / 2, d, (e + c) / 2), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = g, g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = g, a.fill(), a.closePath(), a.restore())
    };
    w.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length)for (var r = 5 < k && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                    ...
                    f = f - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + d) * k << 0;
                    var p = f + k << 0, s;
                    0 <= m[e].y ? s = q : (s = g, g = q);
                    g > s && (s = g = s);
                    ...
                    {id: c, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e, x1: f, y1: g, x2: p, y2: s};
                    c = A(c);
                    ...
                    (m[e].indexLabel || n.indexLabel) && this._indexLabels.push({
                        ...
                        dataPoint: m[e],
                        dataSeries: n,
                        point: {x: f + (p - f) / 2, y: 0 <= m[e].y ? g : s},
                        direction: 0 <= m[e].y ? 1 : -1,
                        bounds: {x1: f, y1: Math.min(g, s), x2: p, y2: Math.max(g, s)},
                        color: c
                    })
                }
            }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < r.length) {
                    ...
                    for (g = 0; g < r.length; g++)if (c = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[g].y) {
                        ...
                        if (0 <= r[g].y) {
                            ...
                            t = q - x;
                            e[c] = x + (t - l)
                        } else x = f[c] ? f[c] : 0, t = l + x, l = q + x, f[c] = x + (t - l);
                        ...
                        this._eventManager.objectMap[c] = {
                            ...
                            dataSeriesIndex: n, dataPointIndex: g, x1: s, y1: l, x2: v, y2: t
                        };
                        c = A(c);
                        ...
                        (r[g].indexLabel || m.indexLabel) && this._indexLabels.push({
                            ...
                            dataPoint: r[g],
                            dataSeries: m,
                            point: {x: d, y: 0 <= r[g].y ? l : t},
                            direction: 0 <= r[g].y ? 1 : -1,
                            bounds: {x1: s, y1: Math.min(l, t), x2: v, y2: Math.max(l, t)},
                            color: c
                        })
                    }
                }
    ...
    w.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c =
                null, d = this.plotArea, e = [], f = [], g = 0, l, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = 0.15 * this.width << 0, h = a.axisX.dataInfo.minDiff, k = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.plotUnits.length) << 0;
            k > g ? k = g : Infinity === h ? k = g : 1 > k && (k = 1);
            b.save();
            u && this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            b.clip();
            u && (this._eventManager.ghostCtx.rect(d.x1, d.y1,
                d.width, d.height), this._eventManager.ghostCtx.clip());
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n = a.dataSeriesIndexes[h], m = this.data[n], r = m.dataPoints;
                if (0 < r.length)for (var p = 5 < k && m.bevelEnabled ? !0 : !1, g = 0; g < r.length; g++)if (c = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[g].y) {
                    ...
                    l = a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit * ((0 !== a.dataPointYSums[c] ? 100 * (r[g].y / a.dataPointYSums[c]) : 0) - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                    var s = d - a.plotType.plotUnits.length * k / 2 + a.index * k << 0, v = s + k << 0, t;
                    if (0 <= r[g].y) {
                        var x = e[c] ? e[c] : 0;
                        l -= x;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length) {
                    ...
                    b.strokeStyle = "#4572A7 ";
                    for (e = 0; e < m.length; e++)if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                        ...
                        g = g - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + d) * k << 0;
                        var p = g + k << 0, s;
                        0 <= m[e].y ? s = q : (s = f, f = q);
                        c = m[e].color ? m[e].color : n._colorSet[e % n._colorSet.length];
                        ...
                        c = n.dataPointIds[e];
                        this._eventManager.objectMap[c] = {
                            id: c, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e,
                            x1: s, y1: g, x2: f, y2: p
                        };
                        c = A(c);
                        ...
                        this._indexLabels.push({
                            ...
                            dataPoint: m[e],
                            dataSeries: n,
                            point: {x: 0 <= m[e].y ? f : s, y: g + (p - g) / 2},
                            direction: 0 <= m[e].y ? 1 : -1,
                            bounds: {x1: Math.min(s, f), y1: g, x2: Math.max(s, f), y2: p},
                            color: c
                        })
                    }
                }
    ...
    w.prototype.renderStackedBar = function (a) {
        var b = this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = [], f = [], g = 0, l, q = a.axisY.conversionParameters.reference +
                a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = 0.15 * this.width << 0, h = a.axisX.dataInfo.minDiff, k = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.plotUnits.length) << 0;
            k > g ? k = g : Infinity === h ? k = g : 1 > k && (k = 1);
            b.save();
            u && this._eventManager.ghostCtx.save();
            b.beginPath();
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n =
                    a.dataSeriesIndexes[h], m = this.data[n], r = m.dataPoints;
                if (0 < r.length) {
                    var p = 5 < k && m.bevelEnabled ? !0 : !1;
                    b.strokeStyle = "#4572A7 ";
                    for (g = 0; g < r.length; g++)if (c = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[g].y) {
                        d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (c - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                        l = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (r[g].y -
                        ...
                        if (0 <= r[g].y) {
                            ...
                            l += x;
                            e[c] = x + (l - t)
                        } else x = f[c] ? f[c] : 0, t = l - x, l = q - x, f[c] = x + (l - t);
                        c = r[g].color ? r[g].color : m._colorSet[g % m._colorSet.length];
                        ...
                        c = A(c);
                        u && D(this._eventManager.ghostCtx, t, s, l, v, c,
                            0, null, !1, !1, !1, !1);
                        this._indexLabels.push({
                            chartType: "stackedBar",
                            dataPoint: r[g],
                            dataSeries: m,
                            point: {x: 0 <= r[g].y ? l : t, y: d},
                            direction: 0 <= r[g].y ? 1 : -1,
                            bounds: {x1: Math.min(t, l), y1: s, x2: Math.max(t, l), y2: v},
                            color: c
                        })
                    }
                }
    ...
    w.prototype.renderStackedBar100 = function (a) {
        var b = this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = [], f = [], g = 0, l, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 -
                a.axisY.conversionParameters.minimum) << 0, g = 0.15 * this.width << 0, h = a.axisX.dataInfo.minDiff, k = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.plotUnits.length) << 0;
            k > g ? k = g : Infinity === h ? k = g : 1 > k && (k = 1);
            b.save();
            u && this._eventManager.ghostCtx.save();
            b.beginPath();
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n = a.dataSeriesIndexes[h],
                    m = this.data[n], r = m.dataPoints;
                if (0 < r.length) {
                    var p = 5 < k && m.bevelEnabled ? !0 : !1;
                    b.strokeStyle = "#4572A7 ";
                    for (g = 0; g < r.length; g++)if (c = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[g].y) {
                        d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (c - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                        l = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * ((0 !== a.dataPointYSums[c] ?
                        100 * (r[g].y / a.dataPointYSums[c]) : 0) - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                        var s = d - a.plotType.plotUnits.length * k / 2 + a.index * k << 0, v = s + k << 0, t;
                        if (0 <= r[g].y) {
                            var x = e[c] ? e[c] : 0;
                            t = q + x;
    ...
    w.prototype.renderArea = function (a) {
        function b() {
            x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.minimum && 0 <= a.axisY.maximum ? t = v : 0 > a.axisY.maximum ? t = f.y1 : 0 < a.axisY.minimum && (t = e.y2), c.lineTo(r, t), c.lineTo(x.x, t), c.closePath(),
                c.globalAlpha = h.fillOpacity, c.fill(), c.globalAlpha = 1, u && (d.lineTo(r, t), d.lineTo(x.x, t), d.closePath(), d.fill()), c.beginPath(), c.moveTo(r, p), d.beginPath(), d.moveTo(r, p), x = {
                x: r,
                y: p
            })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                var q =
                    a.dataSeriesIndexes[l], h = this.data[q], k = h.dataPoints, g = h.id;
                ...
                if (0 < k.length) {
                    ...
                    for (var V = !0; m < k.length; m++)if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[m].y)b(), V = !0; else {
                        ...
                        n || V ? (c.beginPath(), c.moveTo(r, p), x = {
                            x: r,
                            y: p
                        }, u && (d.beginPath(), d.moveTo(r, p)), V = n = !1) : (c.lineTo(r, p), u && d.lineTo(r, p), 0 == m % 250 &&
                        b());
    ...
    w.prototype.renderSplineArea = function (a) {
        function b() {
            ...
            if (0 < b.length) {
                ...
                for (var g = 0; g < b.length - 3; g += 3)c.bezierCurveTo(b[g + 1].x, b[g + 1].y, b[g + 2].x, b[g + 2].y, b[g + 3].x, b[g + 3].y), u && d.bezierCurveTo(b[g + 1].x, b[g + 1].y, b[g + 2].x, b[g + 2].y, b[g + 3].x, b[g + 3].y);
                0 < h.lineThickness && c.stroke();
                0 >= a.axisY.minimum && 0 <= a.axisY.maximum ? s = p : 0 > a.axisY.maximum ?
                    s = f.y1 : 0 < a.axisY.minimum && (s = e.y2);
                v = {x: b[0].x, y: b[0].y};
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.clip();
            u && (d.beginPath(),
                d.rect(l.x1, l.y1, l.width, l.height), d.clip());
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < k.length) {
                    ...
                    c.fillStyle = color;
                    c.strokeStyle = color;
                    for (c.lineWidth = h.lineThickness; n < k.length; n++)if (m = k[n].x.getTime ? k[n].x.getTime() : k[n].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[n].y)0 < n && (b(), t = []); else {
                        ...
                        {id: x, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: n, x1: m, y1: r};
                        t[t.length] = {x: m, y: r};
    ...
    w.prototype.renderStepArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d =
                this._eventManager.ghostCtx, e = a.axisX.lineCoordinates, f = a.axisY.lineCoordinates, g = [], l = this.plotArea;
            c.save();
            u && d.save();
            c.beginPath();
            c.rect(l.x1, l.y1, l.width, l.height);
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                g = A(g);
                d.fillStyle = g;
                var g = [], n = !0, m = 0, r, p, s, v = a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0, t, x = null, E = !1;
                if (0 < k.length) {
                    var w = h._colorSet[m % h._colorSet.length];
                    c.fillStyle = w;
                    c.strokeStyle = w;
                    for (c.lineWidth = h.lineThickness; m < k.length; m++)if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                        var B = p;
                        "number" !== typeof k[m].y ? (b(), E = !0) : (r = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (s - a.axisX.conversionParameters.minimum) +
                        0.5 << 0, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, n || E ? (c.beginPath(), c.moveTo(r, p), x = {
                            x: r,
                            y: p
                            ...
                            x1: r,
                            y1: p
                        }, 0 !== k[m].markerSize && (0 < k[m].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(m,
                            r, p, c), g.push(s), B = A(B), u && g.push({
                            x: r,
                            y: p,
                            ctx: d,
                            type: s.type,
    ...
    w.prototype.renderStackedArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = [], e = this.plotArea,
                f = [], g = [], l = 0, q, h, k, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, m = this._eventManager.ghostCtx;
            u && m.beginPath();
            b.save();
            u && m.save();
            b.beginPath();
            ...
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                for (l = 0; l < s.length; l++)r =
                    s[l].x.getTime ? s[l].x.getTime() : s[l].x, p.dataPointIndexes[r] = l, xValuePresent[r] || (g.push(r), xValuePresent[r] = !0);
                g.sort(qa)
            }
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        {x: k, y: 0};
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof x.y) {
                            ...
                            t.push({x: q, y: n - E});
                            f[k] = n - h;
                            if (v)b.beginPath(), b.moveTo(q, h), u && (m.beginPath(), m.moveTo(q, h)), v = !1; else if (b.lineTo(q,
                                    h), u && m.lineTo(q, h), 0 == l % 250) {
                            ...
                            0 <=
                            p.dataPointIndexes[k] && 0 !== x.markerSize && (0 < x.markerSize || 0 < p.markerSize) && (k = p.getMarkerProperties(l, q, h, b), d.push(k), markerColor = A(B), u && d.push({
                                x: q,
                                y: h,
                                ctx: m,
                                type: k.type,
                    ...
                    for (0 < p.lineThickness && b.stroke(); 0 < t.length;)w = t.pop(), b.lineTo(w.x, w.y), u && m.lineTo(w.x,
                        w.y);
                    b.closePath();
                    b.globalAlpha = p.fillOpacity;
                    b.fill();
    ...
    w.prototype.renderStackedArea100 = function (a) {
        var b = this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = [], f = [], g = [], l = 0, q, h, k, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) <<
                0, m = 0.15 * this.width << 0, r = a.axisX.dataInfo.minDiff, r = 0.9 * d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(r) << 0, p = this._eventManager.ghostCtx;
            b.save();
            u && p.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                v.dataPointIndexes = [];
                for (l = 0; l < t.length; l++)s = t[l].x.getTime ? t[l].x.getTime() : t[l].x, v.dataPointIndexes[s] =
                    l, xValuePresent[s] || (g.push(s), xValuePresent[s] = !0);
                g.sort(qa)
            }
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        {x: k, y: 0};
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof w.y) {
                            ...
                            E.push({x: q, y: n - B});
                            f[k] = n - h;
                            if (x)b.beginPath(), b.moveTo(q,
                                h), u && (p.beginPath(), p.moveTo(q, h)), x = !1; else if (b.lineTo(q, h), u && p.lineTo(q, h), 0 == l % 250) {
                            ...
                            if (0 <= v.dataPointIndexes[k]) {
                                ...
                                this._eventManager.objectMap[y] = {
                                    ...
                                    dataPointIndex: v.dataPointIndexes[k], x1: q, y1: h
                                }
                            }
                            0 <= v.dataPointIndexes[k] && 0 !== w.markerSize && (0 < w.markerSize || 0 < v.markerSize) && (k = v.getMarkerProperties(l, q, h, b), e.push(k), markerColor = A(y), u && e.push({
                                x: q,
                                y: h,
                                ctx: p,
                                type: k.type,
                    ...
                    for (0 < v.lineThickness && b.stroke(); 0 <
                    E.length;)G = E.pop(), b.lineTo(G.x, G.y), u && p.lineTo(G.x, G.y);
                    b.closePath();
                    b.globalAlpha = v.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    w.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= c)) {
            var d = this.plotArea, e = 0, f, g, l = 0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff, c = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) *
                Math.abs(e) / c) << 0;
            b.save();
            u && this._eventManager.ghostCtx.save();
            b.beginPath();
            ...
            b.clip();
            u && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var q = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], m = this.data[n], r = m.dataPoints, p = 0, e = 0; e < r.length; e++)f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof r[e].z ||
            (p = r[e].z, p > q && (q = p), p < h && (h = p));
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), k = 0; k < a.dataSeriesIndexes.length; k++)if (n = a.dataSeriesIndexes[k], m = this.data[n], r = m.dataPoints, 1 == r.length && (c = l), 1 > c ? c = 1 : c > l && (c = l), 0 < r.length)for (b.strokeStyle = "#4572A7 ", e = 0; e < r.length; e++)if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
                ...
                (f - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                ...
                this._eventManager.objectMap[t] = {
                    ...
                    dataSeriesIndex: n, dataPointIndex: e, x1: f, y1: g, size: v
                };
                v = A(t);
    ...
    w.prototype.renderScatter = function (a) {
        var b = this.plotArea.ctx, c = a.dataSeriesIndexes.length;
        if (!(0 >= c)) {
            var d = this.plotArea, e = 0, f, g, l = 0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff,
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                ...
                if (0 < n.length) {
                    b.strokeStyle = "#4572A7 ";
                    Math.pow(0.3 * Math.min(d.height, d.width) /
                    2, 2);
                    for (var m = 0, r = 0, e = 0; e < n.length; e++)if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                        ...
                        I.drawMarker(p.x, p.y, p.ctx, p.type, p.size, p.color, p.color, p.thickness);
                        b.globalAlpha = 1;
                        Math.sqrt((m - f) * (m - f) + (r - g) * (r - g)) < Math.min(p.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (m = k.dataPointIds[e], this._eventManager.objectMap[m] = {
                            ...
                            chartType: "scatter",
                            dataPoint: n[e], dataSeries: k, point: {x: f, y: g}, direction: 1, color: null
                        }), m = f, r = g)
                    }
                }
            }
    ...
    w.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < s.length)for (var v = 5 < n && p.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)if (s[e].getTime ? k = s[e].x.getTime() : k = s[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                    ...
                    q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                    (s[e].y[2] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                    ...
                    "candlestick" === p.type ? (b.moveTo(f - w, l), b.lineTo(f - w, Math.min(g, h)), b.stroke(), b.moveTo(f - w, Math.max(g, h)), b.lineTo(f - w, q), b.stroke(), D(b, t, Math.min(g, h), x, Math.max(g, h), s[e].y[0] <= s[e].y[3] ? p.risingColor : d, E, d, v, v, !1, !1, p.fillOpacity), u && (d = A(B), c.strokeStyle = d, c.moveTo(f - w, l), c.lineTo(f - w, Math.min(g, h)), c.stroke(), c.moveTo(f - w, Math.max(g, h)), c.lineTo(f - w, q), c.stroke(), D(c, t, Math.min(g, h), x, Math.max(g, h), d, 0, null, !1, !1, !1, !1))) : "ohlc" === p.type &&
                    (b.moveTo(f - w, l), b.lineTo(f - w, q), b.stroke(), b.beginPath(), b.moveTo(f, g), b.lineTo(t, g), b.stroke(), b.beginPath(), b.moveTo(f, h), b.lineTo(x, h), b.stroke(), u && (d = A(B), c.strokeStyle = d, c.moveTo(f - w, l), c.lineTo(f - w, q), c.stroke(), c.beginPath(), c.moveTo(f, g), c.lineTo(t, g), c.stroke(), c.beginPath(), c.moveTo(f, h), c.lineTo(x, h), c.stroke()));
    ...
    w.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                var h = a.dataSeriesIndexes[q], k = this.data[h], n = k.dataPoints;
                if (0 < n.length)for (var m = 5 < l && k.bevelEnabled ? !0 : !1, e = 0; e < n.length; e++)if (n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                    ...
                    if (n[e].indexLabel || k.indexLabel)this._indexLabels.push({
                        chartType: "rangeColumn",
                        dataPoint: n[e],
                        dataSeries: k,
                        indexKeyword: 0,
                        point: {x: r + (p - r) / 2, y: n[e].y[1] >= n[e].y[0] ? f : d},
                        direction: n[e].y[1] >= n[e].y[0] ? -1 : 1,
                        bounds: {x1: r, y1: Math.min(d, f), x2: p, y2: Math.max(d, f)},
                        color: c
                    }), this._indexLabels.push({
                        chartType: "rangeColumn",
                        dataPoint: n[e],
                        dataSeries: k,
                        indexKeyword: 1,
                        point: {x: r + (p - r) / 2, y: n[e].y[1] >= n[e].y[0] ? d : f},
                        direction: n[e].y[1] >= n[e].y[0] ? 1 : -1,
                        bounds: {x1: r, y1: Math.min(d, f), x2: p, y2: Math.max(d, f)},
                        color: c
                    })
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    ...
                    b.strokeStyle =
                        "#4572A7 ";
                    for (e = 0; e < m.length; e++)if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                        ...
                        if (m[e].indexLabel || n.indexLabel)this._indexLabels.push({
                            chartType: "rangeBar",
                            dataPoint: m[e],
                            dataSeries: n,
                            indexKeyword: 0,
                            point: {x: m[e].y[1] >= m[e].y[0] ? d : f, y: g + (p - g) / 2},
                            direction: m[e].y[1] >= m[e].y[0] ? -1 : 1,
                            bounds: {x1: Math.min(d, f), y1: g, x2: Math.max(d, f), y2: p},
                            color: c
                        }), this._indexLabels.push({
                            chartType: "rangeBar",
                            dataPoint: m[e],
                            dataSeries: n,
                            indexKeyword: 1,
                            point: {x: m[e].y[1] >= m[e].y[0] ? f : d, y: g + (p - g) / 2},
                            direction: m[e].y[1] >= m[e].y[0] ? 1 : -1,
                            bounds: {
                                x1: Math.min(d, f), y1: g, x2: Math.max(d,
                                    f), y2: p
                            },
                            color: c
                        })
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    ...
                    for (var x = !0; n < h.length; n++)if (s = h[n].x.getTime ? h[n].x.getTime() : h[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))if (null !== h[n].y && h[n].y.length && "number" === typeof h[n].y[0] && "number" === typeof h[n].y[1]) {
                        ...
                        k || x ? (c.beginPath(), c.moveTo(m, r), v = {x: m, y: r}, g = [], g.push({
                            x: m,
                            y: p
                        ...
                        s = q.dataPointIds[n];
                        this._eventManager.objectMap[s] =
                        {id: s, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: n, x1: m, y1: r, y2: p};
                        ...
                        if (h[n].indexLabel || q.indexLabel)this._indexLabels.push({
                            chartType: "rangeArea",
                            dataPoint: h[n],
                            dataSeries: q,
                            indexKeyword: 0,
        ...
        function b() {
            ...
            if (0 < a.length) {
                ...
                u && (d.beginPath(), d.moveTo(a[0].x,
                    a[0].y));
                for (var b = 0; b < a.length - 3; b += 3)c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), u && d.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y);
                0 < l.lineThickness && c.stroke();
                a = fa(p, 2);
                c.lineTo(p[p.length - 1].x, p[p.length - 1].y);
                for (b = a.length - 1; 2 < b; b -= 3)c.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y), u && d.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y);
                c.closePath();
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < q.length) {
                    ...
                    c.fillStyle = color;
                    c.strokeStyle = color;
                    for (c.lineWidth = l.lineThickness; h < q.length; h++)if (k = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(k < a.axisX.dataInfo.viewPortMin ||
                        k > a.axisX.dataInfo.viewPortMax))if (null !== q[h].y && q[h].y.length && "number" === typeof q[h].y[0] && "number" === typeof q[h].y[1]) {
                        ...
                        if (0 !== q[h].markerSize && (0 < q[h].markerSize || 0 < l.markerSize)) {
                            ...
                            t = A(s);
                            u && e.push({
                                x: k, y: m, ctx: d, type: v.type, size: v.size,
                                color: t, borderColor: t, borderThickness: v.borderThickness
                            })
                        }
                        if (q[h].indexLabel || l.indexLabel)this._indexLabels.push({
                            chartType: "splineArea",
                            dataPoint: q[h],
                            dataSeries: l,
                            indexKeyword: 0,
    ...
    var oa = function (a, b, c, d, e, f, g, l) {
    ...
    w.prototype.renderPie = function (a) {
        ...
        function c() {
            if (n &&
                m) {
                for (var a = 0, b = 0; b < m.length; b++)a += Math.abs(m[b].y);
                for (var c = 0, d = 0, e = 0, g = 0, b = 0; b < m.length; b++) {
                    ...
                    h.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ? f.indexLabelWrap : n.indexLabelWrap;
                    h.startAngle = 0 === b ? n.startAngle ? n.startAngle / 180 * Math.PI : 0 : t[b - 1].endAngle;
                    ...
                    if (h.midAngle > Math.PI / 2 - y && h.midAngle < Math.PI / 2 + y) {
                        if (0 === c || t[e].midAngle > h.midAngle)e = b;
                        c++
                    } else if (h.midAngle > 3 * Math.PI / 2 - y && h.midAngle < 3 * Math.PI / 2 + y) {
                        if (0 === d || t[g].midAngle > h.midAngle)g = b;
                        d++
                    }
                ...
                f = a = 0;
                l = !1;
                for (b = 0; b < m.length; b++)h = t[(e + b) % m.length], 1 <
                c && (h.midAngle > Math.PI / 2 - y && h.midAngle < Math.PI / 2 + y) && (a <= c / 2 && !l ? (h.hemisphere = "right", a++) : (h.hemisphere = "left", l = !0));
                l = !1;
                for (b = 0; b < m.length; b++)h = t[(g + b) % m.length], 1 < d && (h.midAngle > 3 * Math.PI / 2 - y && h.midAngle < 3 * Math.PI / 2 + y) && (f <= d / 2 && !l ? (h.hemisphere = "left", f++) : (h.hemisphere = "right", l = !0))
            }
        }
        ...
        function d() {
            ...
            if (null !== v && v.frame < v.maxFrames) {
                ...
                for (var a = v.prevMaxAngle + 2 * Math.PI / v.maxFrames, c = 0; c < m.length; c++) {
                    ...
                    f > g && oa(k.plotArea.ctx, t[c].center, t[c].radius, l, n.type, g, f, n.fillOpacity);
                    if (h)break
                }
                v.frame++;
                v.prevMaxAngle = a;
            ...
            if (null !== v && v.frame < v.maxFrames) {
                ...
                for (a = 0; a < m.length; a++) {
                    ...
                    if (c > b) {
                        ...
                        if (m[a].exploded) {
                            if (Math.abs(t[a].center.x - (G.x + d)) > Math.abs(0.5 * d / v.maxFrames) || Math.abs(t[a].center.y - (G.y + f)) > Math.abs(0.5 * f / v.maxFrames))t[a].center.x += d / v.maxFrames, t[a].center.y += f / v.maxFrames, g = !0
                        } else if (Math.abs(t[a].center.x - G.x) > Math.abs(0.5 * d / v.maxFrames) ||
                            Math.abs(t[a].center.y - G.y) > Math.abs(0.5 * f / v.maxFrames))t[a].center.x -= d / v.maxFrames, t[a].center.y -= f / v.maxFrames, g = !0;
                        g && (d = {}, d.dataSeries = n, d.dataPoint = n.dataPoints[a], d.index = a, k._toolTip.highlightObjects([d]));
                        oa(k.plotArea.ctx, t[a].center, t[a].radius, m[a].color ? m[a].color : n._colorSet[a % n._colorSet.length], n.type, b, c, n.fillOpacity)
                    }
                }
                v.frame++;
                a = k.plotArea.ctx;
                ...
                a.textBaseline = "middle";
                a.lineJoin = "round";
                for (b = b = 0; b < m.length; b++)c = t[b], c.indexLabelText &&
        ...
        function l(a) {
            for (var b = null, c = 1; c < m.length; c++)if (b = (a + c + t.length) % t.length, t[b].hemisphere !== t[a].hemisphere) {
                b = null;
                break
            } else if (t[b].indexLabelText && b !== a && (0 > g(t[b], t[a]) || ("right" === t[a].hemisphere ? t[b].indexLabelTextBlock.y >= t[a].indexLabelTextBlock.y : t[b].indexLabelTextBlock.y <= t[a].indexLabelTextBlock.y)))break; else b = null;
            return b
        }
        ...
        function q(a, b) {
            ...
            if (0 <= a && a <
                m.length) {
                var f = t[a];
                if (0 > b && f.indexLabelTextBlock.y < d || 0 < b && f.indexLabelTextBlock.y > e)return 0;
                ...
                d = null;
                for (e = 1; e < m.length; e++)if (d = (a - e + t.length) % t.length, t[d].hemisphere !== t[a].hemisphere) {
                    d = null;
                    break
                } else if (t[d].indexLabelText && t[d].hemisphere === t[a].hemisphere && d !== a && (0 > g(t[d],
                        t[a]) || ("right" === t[a].hemisphere ? t[d].indexLabelTextBlock.y <= t[a].indexLabelTextBlock.y : t[d].indexLabelTextBlock.y >= t[a].indexLabelTextBlock.y)))break; else d = null;
                n = d;
                k = l(a);
                e = d = 0;
        ...
        function h() {
            ...
            for (var c = 0, e = a = 0, a = 0; 10 > a && (1 > a || 0 < e); a++) {
                ...
                if ("inside" !== n.indexLabelPlacement) {
                    ...
                    for (var s, v,
                        ...
                        if (null !== y) {
                            ...
                            var C = 0, C = g(s, v) - w;
                            if (0 > C) {
                                for (var D = v = s = 0; D < m.length; D++)D !== c && t[D].hemisphere === h.hemisphere && (t[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : v++);
                                D = C / (s + v || 1) * v;
                                s = -1 * (C - D);
                                var H = v = 0;
                ...
                m.length; c++)h = t[c], F = "pie" === n.type ? 0.7 * z : 0.8 * z, C = G.x + F * Math.cos(h.midAngle), D = G.y + F * Math.sin(h.midAngle), h.indexLabelTextBlock.x = C, h.indexLabelTextBlock.y = D;
                for (c = 0; c < m.length; c++)h = t[c], C = h.indexLabelTextBlock.measureText(), 0 !== C.height && 0 !== C.width && (C = C = 0, "right" === h.hemisphere ? (C = p.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + r), C *= -1) : C = p.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - r), 0 < C && (Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - G.y) < z || Math.abs(h.indexLabelTextBlock.y +
                ...
                y = h = -1;
                for (D = H = 0; D < m.length; D++)if (s = t[D], s.indexLabelText) {
                    var I = l(D);
    ...
    H.prototype.render = function (a) {
        ...
        for (c = 0; c < this._wrappedText.lines.length; c++)f = this._wrappedText.lines[c], "right" === this.horizontalAlign ? d = this.width - f.width - this.padding : "left" === this.horizontalAlign ? d = this.padding : "center" === this.horizontalAlign && (d = (this.width -
    ...
    ga.prototype.render = function () {
        ...
        if (0 < g.length) {
            ...
            for (q = p = 0; q < g.length; q++) {
                ...
                if ("horizontal" === this.orientation) {
                    ...
                    if (!h || h.width + k.textBlock.width + (0 === h.width ? 0 : this.horizontalSpacing) > e)h = {
                        items: [],
                        width: 0
                ...
                } else this.height + this.lineHeight < f ? (h = {
                    items: [],
                    width: 0
        ...
        this.items = g;
        for (q = 0; q < this.items.length; q++)k = g[q], k.id = ++this.chart._eventManager.lastObjectId,
        ...
        for (q = 0; q < l.length; q++)for (h = l[q], a = 0; a < h.items.length; a++) {
            k = h.items[a];
            ...
            if ("line" === k.chartType || "stepLine" === k.chartType || "spline" === k.chartType)this.ctx.strokeStyle =
    ...
    O.prototype.getDefaultAxisPlacement = function () {
        ...
        if ("column" === a || "line" === a || "stepLine" === a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a || "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a ||
            "stackedLine100" === a || "stackedArea100" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeArea" === a || "rangeSplineArea" === a)return "normal";
    ...
    O.getDefaultLegendMarker = function (a) {
        if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" ===
            a || "scatter" === a || "stackedColumn100" === a || "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a)return "square";
    ...
    O.prototype.getDataPointAtX = function (a, b) {
        if (!this.dataPoints ||
            0 === this.dataPoints.length)return null;
        var c = {
            dataPoint: null,
            distance: Infinity,
            index: NaN
        ...
        for (; ;) {
            ...
            } else if (0 > k - e && k + e >= this.dataPoints.length)break;
            -1 === g ? (e++, g = 1) : g = -1
        }
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (m) {
                    switch (this.type) {
                        ...
                        case "splineArea":
                        case "scatter":
                            var s = S("markerSize", r, this) || 4, u = c ? 20 : s, p = Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y1 - b, 2));
                            p <= u && d.push({dataPoint: r, dataPointIndex: f, dataSeries: this, distance: p});
                            f = Math.abs(m.x1 - a);
                            f <= q ? q = f : 0 < g ? h++ : k++;
                            p <= s / 2 && (l = !0);
                            break;
                        ...
                        case "candlestick":
                            if (a >= m.x1 - m.borderThickness / 2 && a <= m.x2 + m.borderThickness / 2 && b >= m.y2 - m.borderThickness / 2 && b <=
                                m.y3 + m.borderThickness / 2 || Math.abs(m.x2 - a + m.x1 - a) < m.borderThickness && b >= m.y1 && b <= m.y4)d.push({
                                dataPoint: r,
                                dataPointIndex: f,
                                dataSeries: this,
                            ...
                            break;
                        case "ohlc":
                            if (Math.abs(m.x2 - a + m.x1 - a) < m.borderThickness && b >= m.y2 && b <= m.y3 || a >= m.x1 && a <= (m.x2 + m.x1) / 2 && b >= m.y1 - m.borderThickness / 2 && b <= m.y1 + m.borderThickness / 2 || a >= (m.x1 + m.x2) / 2 && a <= m.x2 && b >= m.y4 - m.borderThickness / 2 && b <= m.y4 + m.borderThickness / 2)d.push({
                                dataPoint: r,
                                dataPointIndex: f,
                                dataSeries: this,
                                distance: Math.min(Math.abs(m.x1 - a), Math.abs(m.x2 - a), Math.abs(m.y2 - b), Math.abs(m.y3 - b))
    ...
    z.prototype.createLabels = function () {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)for (c = pa(new Date(this.maximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < c; pa(b, this.interval,
            this.intervalType))a = b.getTime(), a = "axisX" === this.type && this.labels[a] ? this.labels[a] : xa(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
            x: 0,
            y: 0,
            maxWidth: d,
            maxHeight: e,
            ...
            if (this.labels && this.labels.length) {
                ...
                for (var f = Math.ceil(this.intervalStartPosition), g = !1, b = f; b < this.maximum; b += a)if (this.labels[b])g = !0; else {
                    g = !1;
                    break
                }
                g && (this.interval = a, this.intervalStartPosition = f)
            }
            for (b = this.intervalStartPosition; b <= c; b = parseFloat((b + this.interval).toPrecision(12)))a = "axisX" === this.type && this.labels[b] ? this.labels[b] : W(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: d,
                maxHeight: e,
    ...
    z.prototype.createLabelsAndCalculateWidth = function () {
        ...
        if ("left" === this._position || "right" === this._position)for (this.createLabels(), i = 0; i < this._labels.length; i++) {
            var b = this._labels[i].textBlock.measureText(), c = 0, c = 0 ===
            this.labelAngle ? b.width : b.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + b.height / 2 * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
            a < c && (a = c);
    ...
    z.setLayoutAndRender = function (a, b, c, d, e) {
        ...
        if ("normal" === d) {
            ...
            a.boundingRect = {x1: f, y1: d, x2: g, y2: l, width: g - f, height: l - d};
            b && (f = Math.round(e.x1 + b.margin), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(e.x1 + n + b.margin),
                l = Math.round(e.y2 - m - a.margin), b.lineCoordinates = {
                x1: g,
                y1: d,
                x2: g,
                y2: l,
                height: Math.abs(l - d)
            }, b.boundingRect = {x1: f, y1: d, x2: g, y2: l, width: g - f, height: l - d});
            c && (f = Math.round(a.lineCoordinates.x2), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(f + k + c.margin), l = Math.round(e.y2 - m - a.margin), c.lineCoordinates = {
                ...
                y2: l,
                height: Math.abs(l - d)
            }, c.boundingRect = {x1: f, y1: d, x2: g, y2: l, width: g - f, height: l - d});
            ...
            c && (d = Math.round(e.y1 + c.margin), l = e.y1 + c.margin + r, c.lineCoordinates.y1 =
                l, c.lineCoordinates.y2 = l, c.boundingRect = {x1: f, y1: d, x2: g, y2: l, width: g - f, height: r});
            ...
            a.lineCoordinates = {x1: g, y1: d, x2: g, y2: l, height: Math.abs(l - d)};
            a.boundingRect = {x1: f, y1: d, x2: g, y2: l, width: g - f, height: l - d};
            a.calculateValueToPixelconversionParameters();
            b && b.calculateValueToPixelconversionParameters();
            c && c.calculateValueToPixelconversionParameters();
    ...
    z.prototype.renderLabelsTicksAndTitle = function () {
        ...
        if ("bottom" === this._position) {
            ...
            for (e = 0; e < this._labels.length; e++)if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                ...
                if (!a || 0 === d++ % 2 || this._labels[e].stripLine)f.textBlock.x = b.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5, f.textBlock.y = 0 === this.labelAngle ? b.y - f.textBlock.height /
            ...
            for (e = 0; e < this._labels.length; e++)if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                ...
                if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType)this._labels[e].stripLine ?
                    (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0, this.ctx.beginPath(), this.ctx.moveTo(b.x << 0, c), this.ctx.lineTo(b.x + this.tickLength << 0, c), this.ctx.stroke();
                if (!a || 0 === d++ % 2 || this._labels[e].stripLine)f.textBlock.x = b.x + this.tickLength + 5, f.textBlock.y = 0 === this.labelAngle ? b.y - f.textBlock.height / 2 + this.labelFontSize / 2 : b.y, f.textBlock.render(!0)
            }
            this.title &&
        ...
        if (this.stripLines && 0 < this.stripLines.length && a)for (var b = this.chart.plotArea.ctx, c = 0, c = 0; c < this.stripLines.length; c++) {
            ...
            if (d._thicknessType === a && ("pixel" !== a || !(d.value < this.minimum || d.value > this.maximum))) {
                ...
                if (!(0 >= f)) {
                    ...
                    var g, l, q, h;
                    b.lineWidth = f;
                    if ("bottom" === this._position || "top" === this._position)g = l = 1 === b.lineWidth % 2 ? (e.x << 0) + 0.5 : e.x << 0, q = this.chart.plotArea.y1, h = this.chart.plotArea.y2; else if ("left" === this._position || "right" === this._position)q = h = 1 === b.lineWidth % 2 ? (e.y << 0) + 0.5 : e.y << 0, g = this.chart.plotArea.x1, l = this.chart.plotArea.x2;
                    b.moveTo(g, q);
                    b.lineTo(l, h);
                    b.stroke()
                }
    ...
    z.prototype.calculateAxisParameters = function () {
        ...
        if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", e = Math.abs(this.maximum - this.minimum), 1 > e && (b = Math.floor(Math.abs(Math.log(e) / Math.LN10)) + 2, 2 < b)))for (c = 0; c < b - 2; c++)this.valueFormatString += "#"
    };
    ...
    M.prototype._updateToolTip = function (a, b) {
        if (this.enabled) {
            ...
            if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                g = {};
                if (0 <= this.currentDataPointIndex)c = d.dataPoints[this.currentDataPointIndex], g.dataSeries = d, g.dataPoint = c, g.index = this.currentDataPointIndex, g.distance = Math.abs(c.x - f); else if ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" ===
                    d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type || "candlestick" === d.type || "ohlc" === d.type)f = (this.chart.axisX.maximum - this.chart.axisX.minimum) / this.chart.axisX.lineCoordinates.width * (a - this.chart.axisX.lineCoordinates.x1) + this.chart.axisX.minimum.valueOf(), g = d.getDataPointAtX(f, !0), g.dataSeries = d, this.currentDataPointIndex = g.index, c = g.dataPoint; else return;
    ...
    M.prototype.getToolTipInnerHTML = function (a) {
        a = a.entries;
        for (var b = null, c = null, d = null, e = 0, f = "", g = !0, l = 0; l < a.length; l++)if (a[l].dataSeries.toolTipContent || a[l].dataPoint.toolTipContent) {
            g = !1;
            break
        }
        if (g && this.content && "function" === typeof this.content)b = this.content({entries: a}); else if (this.shared) {
            for (var q =
                "", l = 0; l < a.length; l++)if (c = a[l].dataSeries, d = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (g && !this.content) && (q += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", q += "</br>", q = this.chart.replaceKeywordsWithValue(q, d, c, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== c._options.toolTipContent)) {
                if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" ===
                    c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type)f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}"; else if ("bubble" === c.type)f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}"; else if ("pie" === c.type || "doughnut" === c.type || "funnel" === c.type)f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "&nbsp;&nbsp;{y}"; else if ("rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type)f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent :
    ...
    w.prototype.replaceKeywordsWithValue = function (a, b, c, d, e) {
        ...
        if ((0 <= c.type.indexOf("stacked") || "pie" === c.type ||
            ...
            var g = "#percent", l = "#total", q = null;
            if (0 <= c.type.indexOf("stacked"))l = 0, q = b.x.getTime ? b.x.getTime() : b.x, q in c.plotUnit.yTotals && (l = c.plotUnit.yTotals[q], g = isNaN(b.y) ? 0 : 100 * (b.y / l)); else if ("pie" === c.type || "doughnut" === c.type) {
                for (i = l = 0; i < c.dataPoints.length; i++)isNaN(c.dataPoints[i].y) || (l += c.dataPoints[i].y);
                g = isNaN(b.y) ? 0 : 100 * (b.y / l)
            }
            do {
                q = "";
                if (c.percentFormatString)q = c.percentFormatString; else for (var q = "#,##0.", h = Math.max(Math.ceil(Math.log(1 /
                g) / Math.LN10), 2), k = 0; k < h; k++)q += "#";
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            h = h[a];
            null !== g && (h = h[g]);
            return "x" === a ? f.axisX && "dateTime" === f.plotInfo.axisXValueType ? xa(h, b.xValueFormatString ? b.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : f.axisX && f.axisX.valueFormatString ? f.axisX.valueFormatString : "DD MMM YY", f._cultureInfo) : W(h, b.xValueFormatString ? b.xValueFormatString :
                c.xValueFormatString ? c.xValueFormatString : "#,##0.########", f._cultureInfo) : "y" === a ? W(h, b.yValueFormatString ? b.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo) : "z" === a ? W(h, b.zValueFormatString ? b.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : "#,##0.########", f._cultureInfo) : h
        })
    };
    ...
    Z.prototype.mouseEventHandler = function (a) {
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((d = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[d])if (d = this.objectMap[d], "dataPoint" === d.objectType) {
                ...
                d.eventContext = {
                    context: e, userContext: e._options, mouseover: "mouseover",
