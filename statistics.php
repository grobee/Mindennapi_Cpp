...
class Statistics
{
    ...
    {
        return $this->total_count == 0 ? 0 : number_format(($this->correct_count / $this->total_count) * 100, 2);
    }

    public function getIncorrectPrecentage()
    {
        return $this->total_count == 0 ? 0 : number_format(($this->incorrect_count / $this->total_count) * 100, 2);
    }
